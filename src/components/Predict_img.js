...
export default function Teachable_img() {
  ...
  async function predict() {
    ...
    // var classPrediction = "사진 속 랜드마크 위치는 " + result + " 입니다!"
  ...
  return (
    <div>
      ...
      <main className="container">
        ...
        <div className="filebox"> <label htmlFor="ex_file">사진 업로드</label> <input type="file" id="ex_file"
          onChange={(e) => { setResult(0); encodeFileToBase64(e.target.files[0]); ChangeResultto0(); init() }} /> </div>
        <br />
        <div>{result === 0 ? <h6>로딩중..</h6> : <h6></h6>}</div>
